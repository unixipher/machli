CREATE TYPE "public"."DriverManagerCategory" AS ENUM('large', 'small');--> statement-breakpoint
CREATE TYPE "public"."driverManagerStatus" AS ENUM('active', 'inactive');--> statement-breakpoint
CREATE TYPE "public"."HubManagerCategory" AS ENUM('main', 'intermediate');--> statement-breakpoint
CREATE TYPE "public"."OrderStatus" AS ENUM('created', 'pending', 'in_transit', 'delivered', 'cancelled');--> statement-breakpoint
...
CREATE TABLE "Shop" (
	...
	CONSTRAINT "Shop_token_unique" UNIQUE("token")
);
--> statement-breakpoint
CREATE TABLE "vehicle" (
	...
	"orderId" integer[],
	"drivermanagerId" integer NOT NULL,
